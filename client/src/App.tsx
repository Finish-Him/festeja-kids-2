...
import AgendaSupervisor from "./pages/supervisor/Agenda";
import DashboardSupervisor from "./pages/supervisor/Dashboard";
import VisitacoesSupervisor from "./pages/supervisor/Visitacoes";
import ContratosSupervisor from "./pages/supervisor/Contratos";
import TarefasSupervisor from "./pages/supervisor/Tarefas";
import MetasSupervisor from "./pages/supervisor/Metas";
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/supervisor/agenda" component={AgendaSupervisor} />
      <Route path="/supervisor/dashboard" component={DashboardSupervisor} />
      <Route path="/supervisor/visitacoes" component={VisitacoesSupervisor} />
      <Route path="/supervisor/contratos" component={ContratosSupervisor} />
      <Route path="/supervisor/tarefas" component={TarefasSupervisor} />
      <Route path="/supervisor/metas" component={MetasSupervisor} />
